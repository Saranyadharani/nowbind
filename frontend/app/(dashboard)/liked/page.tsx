...
export default function LikedPage() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    api
      .get<PaginatedResponse<Post>>("/users/me/liked", {
        page: String(page),
        per_page: "10",
      })
      .then((res) => {
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-3xl px-4 py-8">
          <h1 className="mb-2 text-2xl font-bold">Liked Posts</h1>
          <p className="mb-6 text-muted-foreground">Posts you&apos;ve liked.</p>
          ...
          {loading ? (
            ...
            <div className="rounded-lg border p-12 text-center">
              ...
              <p className="text-muted-foreground">
                No liked posts yet. Explore and find posts you love.
              </p>
            </div>
          ) : (
            <>
